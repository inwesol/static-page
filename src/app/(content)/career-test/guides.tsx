      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 ">
        {[
          ...
          const handleDownload = () => {
            ...
            link.href = offering.pdfUrl;
            link.download =
              offering.title.replace(/[^a-z0-9]/gi, "_").toLowerCase() + ".pdf";
          ...
          return (
            <Card
              key={index}
              className="group hover:shadow-2xl transition-all duration-500 border-0 shadow-lg hover:-translate-y-2 bg-white/80 backdrop-blur-sm rounded-xl cursor-pointer"
