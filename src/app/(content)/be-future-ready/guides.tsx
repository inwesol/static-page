        ...
        {Object.keys(sections).map((sectionName: string) => (
          <div key={sectionName} className="space-y-6">
            <div className="flex items-center justify-center gap-2 sm:gap-4">
              ...
              <h3 className="text-base sm:text-xl lg:text-2xl font-bold text-gray-900 px-2 text-center">
                ...
                >
                  ...
                  >
                    ...
                    {sectionName === "Guides" ? (
                      ...
                      <>
                        <div
                          className={`w-10 h-10 sm:w-16 sm:h-16 mb-2 sm:mb-4 rounded-[6px] sm:rounded-xl bg-gradient-to-r ${offering.color} flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300`}
                        >
                          {offering.icon}
                        </div>
                        <h3 className="text-lg sm:text-xl mb-2 sm:mb-4 text-gray-900 group-hover:text-primary-green-600 font-bold transition-colors">
                          {offering.title}
                        </h3>
                        <p className="text-sm sm:text-base text-gray-600 sm:leading-relaxed">
                          {offering.description}
                        </p>
                        <div className="mt-4 sm:mt-6 flex items-center text-primary-green-600 text-sm font-medium group-hover:text-primary-green-700 transition-colors">
                          <FileDown className="size-4 sm:size-5 mr-2" />
