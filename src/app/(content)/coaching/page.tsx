              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-base sm:text-xl text-white leading-snug sm:leading-relaxed font-light">
                    Unlock your true potential through comprehensive
                    psychological assessments, personality analysis, and
                    personalized career guidance to find the career path that
                    perfectly aligns with who you are.
                  </p>
                </div>
              ...
              {[
                {
                  ...
                  description:
                    "Comprehensive personality tests and psychological evaluations to understand your core traits and preferences.",
                  color: "from-primary-blue-500 to-primary-blue-600",
                  bgColor: "bg-primary-blue-50",
                },
                {
                  ...
                  description:
                    "Advanced aptitude tests and skill assessments to identify your natural talents and areas of excellence.",
                  color: "from-primary-green-500 to-primary-green-600",
                  bgColor: "bg-primary-green-50",
                },
                {
                  ...
                  description:
                    "AI-powered career recommendations based on your psychological profile, interests, and market trends.",
                ...
                },
                {
                  ...
                  description:
                    "One-on-one guidance sessions with certified career coaches to develop your personalized action plan.",
            ...
            <div className="max-w-4xl mx-auto">
              <Accordion type="single" collapsible className="space-y-6">
                {[
                  {
                    question:
                      "How accurate are your psychological assessments and career recommendations?",
                    answer:
                      "Our assessments are based on validated psychological instruments and have a 97% accuracy rate in career satisfaction prediction. We use multiple assessment types including personality tests, aptitude evaluations, and interest inventories to provide comprehensive insights. Our recommendations are continuously refined using machine learning and feedback from thousands of successful career matches.",
                  },
                  {
                    question:
                      "How long does the complete career discovery process take?",
                    answer:
                      "The initial assessment phase takes 2-3 hours to complete all psychological tests and evaluations. You'll receive your preliminary results within 24 hours, followed by a detailed analysis and personalized recommendations within 3-5 business days. Our comprehensive coaching sessions are typically spread over 4-6 weeks to ensure thorough exploration and planning.",
                  },
                  {
                    question:
                      "Can your services help with career changes later in my professional life?",
                    answer:
                      "Absolutely! Our services are designed for individuals at any career stage. Whether you're a recent graduate, mid-career professional seeking change, or someone looking to pivot industries, our psychological assessments and coaching adapt to your experience level. We specialize in helping professionals identify transferable skills and navigate career transitions successfully.",
                  },
                  {
                    question:
                      "What types of psychological tests and assessments do you use?",
                    answer:
                      "We employ a comprehensive battery of scientifically validated assessments including the Big Five personality traits, Holland's career interest inventory, cognitive ability tests, emotional intelligence evaluations, and values assessments. Each test is specifically chosen to provide insights into different aspects of your professional compatibility and potential for success in various career paths.",
                  },
                  {
                    question:
                      "Do you provide ongoing support after the initial career guidance?",
                    answer:
                      "Yes! We believe career development is an ongoing journey. Our support includes quarterly check-ins, access to our career resource library, ongoing coaching sessions, skill development recommendations, and career pivot guidance as your interests and market conditions evolve. We offer flexible support packages to match your long-term career development needs.",
                  },
                ].map((faq, index) => (
                  <AccordionItem
                    key={index}
              ...
              <div className="text-white space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-base sm:text-xl text-white/90 sm:leading-relaxed">
                    ...
                    psychological assessments and personalized guidance. Let's
                    unlock your true potential and find the career that aligns
