      ...
      <CardContent className="p-4 pt-0 sm:p-8 sm:pt-4 ">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              Current Organization <span className="text-red-600">*</span>
            </Label>
            <Input
              id="instituteName"
              {...register("instituteName")}
              className="border-gray-300 rounded-[10px] bg-white placeholder:text-slate-400"
              placeholder="Your current school, college, or company"
            />
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Tell us about your career goals, current situation, and what you hope to achieve through our career guidance services..."
            />
            {errors.message && (
