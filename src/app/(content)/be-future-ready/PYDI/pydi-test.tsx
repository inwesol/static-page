          ...
          <CardContent>
            ...
            <div className="flex flex-wrap gap-1.5 justify-center mb-6">
              {Array.from({ length: totalPages }).map((_, index) => {
                ...
                const isPageCompleted = pageQuestions.every(
                  (q) => allAnswers?.[q.id]
                );
                ...
                return (
                  <Button
                    ...
                    className={`
                      size-10 rounded-xl font-bold text-sm  transition-all duration-300 hover:scale-105 flex justify-center items-center
                      ${
                        index === currentPage
                          ? "bg-gradient-to-r from-primary-blue-500 to-primary-green-500 text-white shadow-md"
                          : isPageCompleted
                          ? "bg-primary-green-50 text-primary-green-600 hover:bg-primary-green-200 "
                          : "bg-slate-50 text-slate-500 hover:bg-slate-200"
                      }
                    `}
                  >
                    {isPageCompleted && index !== currentPage ? (
                      <CheckCircle className="size-10 text-primary-green-600" />
                    ) : (
                      index + 1
                    )}
                  </Button>
            ...
            <div className="flex flex-col gap-3 pt-6 mt-6 border-t sm:flex-row border-slate-200">
              ...
              <Button
                ...
                className="flex items-center justify-center w-full h-10 gap-2 font-medium transition-all duration-200 bg-white border rounded-xl sm:flex-1 border-slate-300 hover:bg-slate-50 text-slate-700 disabled:opacity-50 disabled:cursor-not-allowed group"
              >
              ...
              {currentPage === totalPages - 1 ? (
                <Button
                  ...
                  className="w-full sm:flex-1 h-10 bg-gradient-to-r from-primary-green-500 to-primary-green-600 hover:from-primary-green-600 hover:to-primary-green-700 text-white font-medium rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] transition-all duration-300 group flex items-center justify-center gap-2"
                >
                  Submit Response
                ...
                <Button
                  ...
                  className="w-full sm:flex-1 h-10 bg-gradient-to-r from-primary-blue-500 to-primary-blue-600 hover:from-primary-blue-600 hover:to-primary-blue-700 text-white font-medium rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] transition-all duration-300 group flex items-center justify-center gap-2"
                >
                  Next
