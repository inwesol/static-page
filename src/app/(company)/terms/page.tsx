    ...
    <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
      <AnimationContainer delay={0.1} className="w-full">
        ...
        <p className="mt-8 text-muted-foreground">
          By accessing and using Inwesol, you accept and agree to be bound by
        ...
        <p className="mt-8 text-muted-foreground">
          Inwesol reserves the right to modify these terms at any time. We will
        ...
        <p className="mt-8">
          To use Inwesol, you must be at least 18 years old and capable of
        ...
        <div className="mt-8">
          You agree not to use Inwesol for any unlawful or prohibited
        ...
        <p className="mt-8 text-muted-foreground">
          Inwesol provides a URL shortening service that allows you to create
        ...
        <p className="mt-8 text-muted-foreground">
          Inwesol offers analytics for your shortened URLs. You agree to use
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          Inwesol. However, by uploading or creating content, you grant Inwesol
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          Inwesol does not endorse or assume any liability for user content.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          Inwesol reserves the right to suspend or terminate your account at any
        ...
        <p className="mt-8 text-muted-foreground">
          Inwesol is provided on an &quot;as is&quot; and &quot;as
        ...
        <p className="mt-8 text-muted-foreground">
          In no event shall Inwesol be liable for any indirect, incidental,
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          please contact us at contact@inwesol.com.
        </p>

        <p className="mt-8 font-medium">
          By using Inwesol, you acknowledge that you have read, understood, and
