...
const featuredBlogs = [
  {
    ...
    description: "A process where trained professionals help individuals identify their strengths and interests through self-assessments, enabling them to make informed career decisions.",
    image:
